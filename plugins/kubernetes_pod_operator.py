...
class MyKubernetesPodOperator(BaseOperator):
    """
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(MyKubernetesPodOperator, self).__init__(*args, **kwargs)
        self.image = image
...
class KubePlugin(AirflowPlugin):
    name = "kube_plugin"
    operators = [MyKubernetesPodOperator]
